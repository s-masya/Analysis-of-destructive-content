...
class Page(FloatLayout):
    ...
    def Analis(self,instance):
        ...
        restext+= '\n\n\nПри выявлении деструктивного контента (противоправной информации) в открытых источниках следует подать обращение на официальном сайте Роскомнадзора: https://eais.rkn.gov.ru/feedback/'
